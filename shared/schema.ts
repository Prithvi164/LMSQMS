...
// Update User Processes junction table
...
export const organizationLineOfBusinessesRelations = relations(organizationLineOfBusinesses, ({ one, many }) => ({
    organization: one(organizations, {
        fields: [organizationLineOfBusinesses.organizationId],
        references: [organizations.id],
    }),
    processes: many(organizationProcesses)
}));
