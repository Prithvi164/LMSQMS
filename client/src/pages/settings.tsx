...
import { Users, UserCircle, Shield, ChevronLeft, Network, CalendarDays, Cloud } from "lucide-react";
...
import CloudStorageSettings from "@/pages/settings/cloud-storage";

type SettingsTab = "profile" | "users" | "permissions" | "organization-tree" | "organization-settings" | "cloud-storage";
...
export default function Settings(): React.JSX.Element {
  ...
  const getPageTitle = () => {
    ...
    if (activeTab === "cloud-storage") return "Cloud Storage Configuration";
      ...
      <div className="flex h-screen">
        ...
        <div className="w-64 border-r bg-background flex flex-col">
          ...
          <div className="p-4 space-y-2 flex-1">
            ...
            <NavTab
              active={activeTab === "cloud-storage"}
              icon={Cloud}
