    ...
    <div className="space-y-6">
      ...
      <Card>
        ...
        <CardContent className="pt-6">
          ...
          {/* Assessments & Certifications Tab */}
          <TabsContent value="assessments">
            <div className="space-y-6">
              {/* Insights Card */}
              <Card>
                <CardHeader>
                  <CardTitle className="text-base">Assessment Insights</CardTitle>
                  <CardDescription>
                    Performance metrics for all assessments in this batch
                  </CardDescription>
                </CardHeader>
                <CardContent>
                  <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                        ...
                        <Table>
                          ...
                          <TableBody>
                            <TableRow>
                              ...
                              <TableCell>Customer Service Basics</TableCell>
                            ...
                            <TableRow>
                              <TableCell className="font-medium">Daniel Taylor</TableCell>
                              <TableCell>Problem Resolution</TableCell>
                              ...
                              <TableCell className="text-right">
                                <DropdownMenu>
                                  ...
                                  <DropdownMenuContent align="end">
                                    ...
                                    <DropdownMenuItem>
                                      <CalendarClock className="mr-2 h-4 w-4" /> Schedule Refresher
                                    </DropdownMenuItem>
                                  </DropdownMenuContent>
                                </DropdownMenu>
                              </TableCell>
                            ...
                            <TableRow>
                              ...
                              <TableCell>March 27, 2025</TableCell>
                              <TableCell className="text-right">
                                <Button variant="ghost" size="icon">
                                  <Eye className="h-4 w-4" />
                                </Button>
                            ...
                            <TableRow>
                              ...
                              <TableCell>System Navigation</TableCell>
                            ...
                            <TableRow>
                              ...
                              <TableCell>Call Quality Standards</TableCell>
                              <TableCell>78%</TableCell>
                              <TableCell>
                                <Badge variant="default">Passed</Badge>
                              </TableCell>
                              <TableCell>March 26, 2025</TableCell>
                              <TableCell className="text-right">
                                <Button variant="ghost" size="icon">
                                  <Eye className="h-4 w-4" />
                                </Button>
                      ...
                      <div className="rounded-md border">
                        <Table>
                          ...
                          <TableBody>
                            ...
                            <TableRow>
                              <TableCell className="font-medium">Ryan Johnson</TableCell>
                              <TableCell>Customer Empathy</TableCell>
                      ...
                      <div className="rounded-md border">
                        <Table>
                          ...
                          <TableBody>
                            ...
                            <TableRow>
                              <TableCell className="font-medium">Ethan Brown</TableCell>
                              <TableCell>Compliance Essentials</TableCell>
                            ...
                            <TableRow>
                              <TableCell className="font-medium">Ava Garcia</TableCell>
                              <TableCell>Call Handling</TableCell>
                              <TableCell>88%</TableCell>
                              <TableCell>March 24, 2025</TableCell>
                              <TableCell className="text-right">
                                <Button variant="ghost" size="icon">
                                  <Eye className="h-4 w-4" />
                                </Button>
              ...
              <Card>
                <CardHeader>
                  ...
                  <CardDescription>
                    Current certification status for all trainees
                  </CardDescription>
                </CardHeader>
                <CardContent>
                  <div className="rounded-md border">
                    <Table>
                      <TableHeader>
                        <TableRow>
                          ...
                          <TableHead>Certification Progress</TableHead>
                          <TableHead>Status</TableHead>
                          <TableHead className="text-right">Actions</TableHead>
                        </TableRow>
                      </TableHeader>
                        ...
                        <TableRow>
                          ...
                          <TableCell>
                            <div className="flex items-center gap-2">
                              <Progress value={83} className="h-2 w-full" />
